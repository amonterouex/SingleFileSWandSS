...
int CheckData(InputData *indata){
    ...
    //Check value of corona size
    if(indata->r0<1.0 || indata->r0>2.0000001*sqrt(1-indata->eps*indata->eps)){
        std::cout << "r0 = " << indata->r0 << std::endl;
        std::cout << "ERROR: Value of corona size is too large, please decrease it." << std::endl;
        return 1;
        }
    else{
        std::cout << "r0:" << indata->r0 << std::endl;
    ...
    //Check value of temperature
    //if(indata->temperature<=0.0){
    //    std::cout << "temperature = " << indata->temperature << std::endl;
    //    std::cout << "ERROR: Please choose a positive temperature." << std::endl;
    //    return 1;
    //    }
    //else{
    //    std::cout << "temperature:" << indata->temperature << std::endl;
    ...
    if(indata->comValue!=1 && indata->comValue!=2 && indata->comValue!=3 && indata->comValue!=4&& indata->comValue!=5){
    ...
    if(indata->nsize<=1){
        std::cout << "ERROR: number of discretization parameter must be 2 or higher." << std::endl;
        return 1;
        }
        else{
            std::cout << "nsize:" << indata->nsize << std::endl;
    }
